...
class Metaclass_GetTransform(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.srv.GetTransform')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_interfaces.srv import _get_transform
...
class GetTransform(metaclass=Metaclass_GetTransform):
    from my_robot_interfaces.srv._get_transform import GetTransform_Request as Request
    from my_robot_interfaces.srv._get_transform import GetTransform_Response as Response
