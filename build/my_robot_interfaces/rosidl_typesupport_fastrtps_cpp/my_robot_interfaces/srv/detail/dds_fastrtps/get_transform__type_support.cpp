...
#include "my_robot_interfaces/srv/detail/get_transform__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::srv::GetTransform_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::srv::GetTransform_Request & ros_message)
{
  // Member: frame_id
  cdr >> ros_message.frame_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::srv::GetTransform_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::GetTransform_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::srv::GetTransform_Request *>(
    untyped_ros_message);
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetTransform_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, GetTransform_Request)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetTransform_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::srv::GetTransform_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: transform
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::srv::GetTransform_Response & ros_message)
{
  // Member: transform
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::srv::GetTransform_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::GetTransform_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::srv::GetTransform_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetTransform_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, GetTransform_Response)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetTransform_Response__handle;
}
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetTransform__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, GetTransform)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetTransform__handle;
}
